...
export function openapi({ origin, version, badjsonFlavors, sseFlavors, rangeFlavors, etagFlavors, cookieFlavors, authFlavors, compressFlavors, crosshostFlavors, x402Scenarios, x402Broken, x402Limits }) {
  ...
  const paths = {
      ...
      '/auth': { get: { summary: 'Index of the HTTP-authentication flavors, the public fake test credentials, the safety warning, and the witness block: what eight real clients did at every flavor, derived from the /clients.jsonl auth rows', responses: { 200: jsonResp('{flavors, usage, credentials, warning, witness: {measured, observations, data, data_note, what_this_is, clients[], findings[], what_the_oracle_cannot_tell_you, reproduce}}') } } },
      '/auth/{flavor}': {
        get: {
